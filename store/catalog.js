...
class Product
{
    ...
    CreateDisplay(parent, width = "175px", height = "175px", ignoreFunctionality = false)
    {
        ...
        if(currentUser != undefined && !ignoreFunctionality)
        {
            if(this.GetTotalPrice() > currentUser.money)
            {
        ...
        if(this.Data.pack != undefined)
        {
            ...
            switch(this.Type)
            {
                ...
                case PRODUCT_TYPE.STAT_DISPLAY:
                    ...
                    {
                        statDisplay.textContent = currentUser.stats[this.Data.value] + this.Data.suffix;
                    }else{
                        statDisplay.textContent = this.Name + ": " + currentUser.stats[this.Data.value];
                    }
        ...
        {
            if(currentUser != undefined && this.GetTotalPrice() > currentUser.money)
            {
...
const MAIN_PACK_CATALOG = [
    {name: "Basic Font Pack", price: 750, contains: [0], rarity: "basic"},
    ...
    {name: "Basic Chip Set Pack", price: 5250, contains: [3], rarity: "basic"},
    {name: "Basic Card Pack", price: 5000, contains: [4], rarity: "basic"}
]
